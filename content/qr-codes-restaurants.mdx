# Restaurant QR Code: Menus and Contactless Ordering

Restaurants have embraced QR codes for menus, ordering, and payments. Here's how to use them effectively.

![QR code on restaurant table tent for contactless menu](/blog/qr-illustration.svg)
...
[Create your free restaurant menu QR code](/) or [Wi‑Fi QR code for guest login](/wifi-qr-generator) here.